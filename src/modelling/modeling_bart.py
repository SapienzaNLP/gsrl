...
class CustomBartEncoder(nn.Module):
    ...
    def __init__(self, config: bart.BartConfig, embed_tokens):
        super().__init__()
...
class CustomBartDecoder(nn.Module):
    ...
    def __init__(self, config: bart.BartConfig, embed_tokens: nn.Embedding, gr_mode=True):
        super().__init__()
        self.output_attentions = config.output_attentions
        self.output_hidden_states = config.output_hidden_states
        self.dropout = config.dropout
...
class CustomBartModel(bart.PretrainedBartModel):
    ...
    def sentence_mode(self):
        return self.decoder.gr_mode

    @sentence_mode.setter
    def sentence_mode(self, value):
        assert isinstance(value, bool)
        self.decoder.gr_mode = value
...
class CustomBartForConditionalGeneration(bart.PretrainedBartModel):
    base_model_prefix = "model"

    def __init__(self, config: bart.BartConfig):
        super().__init__(config)
        base_model = CustomBartModel(config)
    ...
    def init_reverse_model(self):
        rev = CustomBartForConditionalGeneration(self.model.config)
    ...
    @property
    def gr_mode(self):
        return self.model.decoder.gr_mode

    @gr_mode.setter
    def gr_mode(self, value):
        assert isinstance(value, bool)
        self.model.decoder.gr_mode = value
